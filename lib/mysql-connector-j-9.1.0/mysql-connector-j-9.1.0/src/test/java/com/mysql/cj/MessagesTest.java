...
public class MessagesTest {
    ...
    public void testLocalizedErrorMessages() throws Exception {
        ...
        assertEquals("Malformed database URL, failed to parse the URL authority segment 'main.java.Test'.",
        ...
        assertEquals("Malformed database URL, failed to parse the connection string near 'main.java.Test'.",
                Messages.getString("ConnectionString.4", new Object[] { "Test" }));
        assertEquals("Connector/J cannot handle a database URL of type 'main.java.Test'.", Messages.getString("ConnectionString.5", new Object[] { "Test" }));
        assertEquals("Connector/J cannot handle a database URL of type 'main.java.Test' that takes 100 hosts.",
        ...
        assertEquals("Illegal transformation to the 'main.java.Test' property. The value 'Ten' is not a valid number.",
        ...
        assertEquals("Can't find configuration template named 'main.java.Test'", Messages.getString("ConnectionString.10", new Object[] { "Test" }));
        assertEquals("Unable to load configuration template 'main.java.Test' due to underlying IOException",
        ...
        assertEquals("Illegal database URL, in a 'main.java.Test' multi-host connection it is required the same credentials in all hosts.",
                Messages.getString("ConnectionString.14", new Object[] { "Test" }));
        assertEquals("Illegal database URL, in a 'main.java.Test' multi-host connection it is required that all or none of the hosts set a \"priority\" value.",
                Messages.getString("ConnectionString.15", new Object[] { "Test" }));
        assertEquals("Illegal database URL, in a 'main.java.Test' multi-host connection the \"priority\" setting must be a value between 0 and 100.",
        ...
        assertEquals("Unsupported character encoding 'main.java.Test'", Messages.getString("Field.12", new Object[] { "Test" }));
        assertEquals("Unsupported character encoding 'main.java.Test'", Messages.getString("StringUtils.0", new Object[] { "Test" }));
        ...
        assertEquals("No parameter named 'main.java.Test'", Messages.getString("CallableStatement.3", new Object[] { "Test" }));
        assertEquals("Parameter named 'main.java.Test' is not an OUT parameter", Messages.getString("CallableStatement.5", new Object[] { "Test" }));
        assertEquals("Can't find local placeholder mapping for parameter named 'main.java.Test'.", Messages.getString("CallableStatement.6", new Object[] { "Test" }));
        ...
        assertEquals(
                "Unknown character set index 'main.java.Test' received from server. The appropriate client character set can be forced via the 'characterEncoding' property.",
                Messages.getString("Connection.6", new Object[] { "Test" }));
        assertEquals("Can't map main.java.Test given for characterSetResults to a supported MySQL encoding.",
        ...
        assertEquals("Savepoint 'main.java.Test' does not exist", Messages.getString("Connection.22", new Object[] { "Test" }));
        assertEquals("Unsupported transaction isolation level 'main.java.Test'", Messages.getString("Connection.25", new Object[] { "Test" }));
        ...
        assertEquals("Syntax error while processing {fn convert (... , ...)} token, missing opening parenthesis in token 'main.java.Test'.",
                Messages.getString("EscapeProcessor.4", new Object[] { "Test" }));
        assertEquals("Unsupported conversion type 'main.java.Test' found while processing escape token.",
        ...
        assertEquals("'main.java.Test' is not a valid numeric or approximate numeric value", Messages.getString("PreparedStatement.64", new Object[] { "Test" }));
        ...
        assertEquals("No conversion from main.java.Test to Types.BOOLEAN possible.", Messages.getString("PreparedStatement.66", new Object[] { "Test" }));
        ...
        assertEquals("Illegal hour value '99' for java.sql.Time type in value 'main.java.Test'.", Messages.getString("TimeUtil.0", new Object[] { 99, "Test" }));
        assertEquals("Illegal minute value '99' for java.sql.Time type in value 'main.java.Test'.", Messages.getString("TimeUtil.1", new Object[] { 99, "Test" }));
        assertEquals("Illegal second value '99' for java.sql.Time type in value 'main.java.Test'.", Messages.getString("TimeUtil.2", new Object[] { 99, "Test" }));
