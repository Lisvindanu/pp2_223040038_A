...
public class StringRegressionTest extends BaseTestCase {
    ...
    public void testBug25047() throws Exception {
        assertEquals(26, StringUtils.indexOfIgnoreCase(0, "insert into main.java.Test (TestID) values (?)", "VALUES", "`", "`", SearchMode.__MRK_COM_MYM_HNT_WS));
        assertEquals(26, StringUtils.indexOfIgnoreCase(0, "insert into main.java.Test (TestID) VALUES (?)", "values", "`", "`", SearchMode.__MRK_COM_MYM_HNT_WS));

        assertEquals(StringUtils.indexOfIgnoreCase(0, "insert into main.java.Test (TestID) values (?)", "VALUES", "`", "`", SearchMode.__MRK_COM_MYM_HNT_WS),
                StringUtils.indexOfIgnoreCase(0, "insert into main.java.Test (TestID) VALUES (?)", "VALUES", "`", "`", SearchMode.__MRK_COM_MYM_HNT_WS));
        assertEquals(StringUtils.indexOfIgnoreCase(0, "insert into main.java.Test (TestID) values (?)", "values", "`", "`", SearchMode.__MRK_COM_MYM_HNT_WS),
                StringUtils.indexOfIgnoreCase(0, "insert into main.java.Test (TestID) VALUES (?)", "values", "`", "`", SearchMode.__MRK_COM_MYM_HNT_WS));
    }
